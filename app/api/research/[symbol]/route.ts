 ...
 * Deep research on a specific stock using Dedalus Sonar
 * 
 * Example: /api/research/AAPL
 */
export async function GET(
  ...
  try {
    ...
    console.log(`🔍 [API] Research request for ${symbol}`)
    
    // Research using MCP Sonar
    const researchData = await researchStockWithSonar(symbol)
